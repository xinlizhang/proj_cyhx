<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:40:"/data/web/vshop/themes/default/index.dwt";i:1;s:52:"/data/web/vshop/themes/default/library/cat_goods.lbi";i:2;s:58:"/data/web/vshop/themes/default/library/page_index_menu.lbi";i:3;s:55:"/data/web/vshop/themes/default/library/search_index.lbi";i:4;s:54:"/data/web/vshop/themes/default/library/page_footer.lbi";}s:7:"expires";i:1495607249;s:8:"maketime";i:1495603649;}<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<header class="index-header comWidth">
  <i class="index-header-menu iconfont fl" onclick="window.location = '/vshop/index.php?m=default&c=category&a=top_all&u=8'">&#xe627;</i>
...
<div class="index-main comWidth">
    ...
    <ul class="index-menu-ul">
        <li class="fl"><a href="index.php?c=category&amp;a=top_all"><img src="themes/default/images/nav/nav_0.png" /></a><a class="index-menu-text" href="index.php?c=category&amp;a=top_all">全部分类</a></li>
        <li class="fl"><a href="index.php?c=user&amp;a=order_list"><img src="themes/default/images/nav/nav_1.png" /></a><a class="index-menu-text" href="index.php?c=user&amp;a=order_list">我的订单</a></li>
        <li class="fl"><a href="index.php?c=groupbuy"><img src="themes/default/images/nav/nav_4.png" /></a><a class="index-menu-text" href="index.php?c=groupbuy">最新团购</a></li>
        <li class="fl"><a href="index.php?c=activity"><img src="themes/default/images/nav/nav_3.png" /></a><a class="index-menu-text" href="index.php?c=activity">促销活动</a></li>
        <li class="fl"><a href="javascript:openSearch();"><img src="themes/default/images/nav/nav_6.png" /></a><a class="index-menu-text" href="javascript:openSearch();">热门搜索</a></li>
        <li class="fl"><a href="index.php?c=brand"><img src="themes/default/images/nav/nav_2.png" /></a><a class="index-menu-text" href="index.php?c=brand">品牌街</a></li>
        <li class="fl"><a href="index.php?c=user"><img src="themes/default/images/nav/nav_5.png" /></a><a class="index-menu-text" href="index.php?c=user">个人中心</a></li>
        <li class="fl"><a href="index.php?c=flow&amp;a=cart"><img src="themes/default/images/nav/nav_7.png" /></a><a class="index-menu-text" href="index.php?c=flow&amp;a=cart">购物车</a></li>
        </ul>
    </div>
  <div class="index-recom">
      <div class="index-recom-left fl">
        554fcae493e564ee0dc75bdf2ebf94caads|a:3:{s:4:"name";s:3:"ads";s:2:"id";s:3:"257";s:3:"num";s:1:"1";}554fcae493e564ee0dc75bdf2ebf94ca      </div>
  ...
  <div class="index-theme" style="display:none">
    ...
    <div class="single_item">
        <li class="fl" style="background-color: #FFFFFF;">
          <a href="/vshop/index.php?m=default&c=goods&a=index&id=3&u=8"><img src="http://www.disanqiche.com/vshop/images/201705/goods_img/3_G_1495574619324.jpg" alt="八爪鱼" /></a>
      <a href="/vshop/index.php?m=default&c=goods&a=index&id=3&u=8"><p>八爪鱼</p></a>
      <span>￥0.00元</span>
    </li>
    </div>
    ...
    <div class="single_item">
        <li class="fr" style="background-color: #FFFFFF;">
          <a href="/vshop/index.php?m=default&c=goods&a=index&id=1&u=8"><img src="/vshop/data/common/images/no_picture.gif" alt="鲤鱼" /></a>
      <a href="/vshop/index.php?m=default&c=goods&a=index&id=1&u=8"><p>鲤鱼</p></a>
      <span>￥0.10元</span>
    </li>
    </div>
...
<footer class="index-footer comWidth">
	<ul>
	<li class="fl index-footer-list"><a href="/vshop/index.php?m=default&c=index&a=index&u=8"><i class="iconfont">&#xe621;</i><span>首页</span></a></li>
	<li class="fl index-footer-list"><a href="/vshop/index.php?m=default&c=category&a=top_all&u=8"><i class="iconfont">&#xe627;</i><span>分类</span></a></li>
	<li class="fl index-footer-list"><a href="javascript:openSearch();"><i class="iconfont">&#xe617;</i><span>搜索</span></a></li>
	<li class="fl index-footer-list"><a href="/vshop/index.php?m=default&c=flow&a=cart&u=8"><i class="iconfont">&#xe626;</i><span>购物车</span></a></li>
		<li class="fl index-footer-list"><a href="/vshop/index.php?m=default&c=user&a=index&u=8"><i class="iconfont">&#xe625;</i><span>用户中心</span></a></li>
...
<div class="search" style="display:none;">
	...
	<div class="ect-padding-lr">
		<form action="/vshop/index.php?m=default&c=category&a=index&u=8"  method="post" id="searchForm" name="searchForm">
...
get_asynclist("/vshop/index.php?m=default&c=index&a=ajax_goods&type=best&u=8" , '__TPL__/images/loader.gif');
</script>
<script>
	/*立即关注*/
	$(function($) {
